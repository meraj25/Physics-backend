...
var getAllStudyPacks = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Studypack_1.default.find()];
            case 1:
                studyPack = _a.sent();
                res.json(studyPack);
                return [3 /*break*/, 3];
...
var createStudyPack = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                result = studypack_1.CreateStudyPackDTO.safeParse(req.body);
                if (!result.success) {
...
var deleteStudyPack = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deleteStudyPack_1, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Studypack_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                deleteStudyPack_1 = _a.sent();
                if (!deleteStudyPack_1) {
