...
var pecontent_1 = require("../domain/dto/pecontent");
...
var getAllPEContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pecontent, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, PEContent_1.default.find()];
            case 1:
                pecontent = _a.sent();
                res.json(pecontent);
                return [3 /*break*/, 3];
...
var createPEContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var result, _a, heading, assignment, topic, pre_content, link, paymentstatus, price, thumbnail_url, pecontent, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                result = pecontent_1.CreatePEDTO.safeParse(req.body);
                if (!result.success) {
                ...
                return [4 /*yield*/, PEContent_1.default.create({
                        heading: heading,
...
var deletePEContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deletePEContent_1, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, PEContent_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                deletePEContent_1 = _a.sent();
                if (!deletePEContent_1) {
