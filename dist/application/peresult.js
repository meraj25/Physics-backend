...
var PEResult_1 = __importDefault(require("../infrastructure/db/entities/PEResult"));
...
var GetResults = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var peresults, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, PEResult_1.default.find()];
            case 1:
                peresults = _a.sent();
                res.json(peresults);
                return [3 /*break*/, 3];
...
var AddResult = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newPEResult, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newPEResult = req.body;
                if (!newPEResult.contentId) {
                    throw new validation_error_1.default("Result contentId is required");
                }
                return [4 /*yield*/, PEResult_1.default.create(newPEResult)];
            case 1:
                _a.sent();
