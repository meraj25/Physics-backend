...
var SPResult_1 = __importDefault(require("../infrastructure/db/entities/SPResult"));
...
var GetResults = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var spresults, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, SPResult_1.default.find()];
            case 1:
                spresults = _a.sent();
                res.json(spresults);
                return [3 /*break*/, 3];
...
var AddResult = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newSPResult, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newSPResult = req.body;
                if (!newSPResult.contentId) {
                    throw new validation_error_1.default("Result contentId is required");
                }
                return [4 /*yield*/, SPResult_1.default.create(newSPResult)];
            case 1:
                _a.sent();
