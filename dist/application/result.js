...
var Result_1 = __importDefault(require("../infrastructure/db/entities/Result"));
...
var GetResults = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Result_1.default.find()];
            case 1:
                results = _a.sent();
                res.json(results);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Result_1.default.create(newResult)];
            case 1:
                _a.sent();
