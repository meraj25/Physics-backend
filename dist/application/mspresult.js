...
var MSPResult_1 = __importDefault(require("../infrastructure/db/entities/MSPResult"));
...
var GetResults = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var mspresults, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, MSPResult_1.default.find()];
            case 1:
                mspresults = _a.sent();
                res.json(mspresults);
                return [3 /*break*/, 3];
...
var AddResult = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newMSPResult, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newMSPResult = req.body;
                if (!newMSPResult.contentId) {
                    throw new validation_error_1.default("Result contentId is required");
                }
                return [4 /*yield*/, MSPResult_1.default.create(newMSPResult)];
            case 1:
                _a.sent();
