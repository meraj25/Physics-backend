...
var mathscontent_1 = require("../domain/dto/mathscontent");
...
var getAllMathsContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var mathscontent, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, MathsContent_1.default.find()];
            case 1:
                mathscontent = _a.sent();
...
var createMathsContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var result, _a, heading, assignment, topic, pre_content, link, paymentstatus, price, thumbnail_url, mathscontent, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                result = mathscontent_1.CreateMathsDTO.safeParse(req.body);
                if (!result.success) {
                ...
                return [4 /*yield*/, MathsContent_1.default.create({
                        heading: heading,
...
var deleteMathsContent = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var deleteMathsContent_1, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, MathsContent_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                deleteMathsContent_1 = _a.sent();
                if (!deleteMathsContent_1) {
