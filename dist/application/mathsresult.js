...
var MathsResult_1 = __importDefault(require("../infrastructure/db/entities/MathsResult"));
...
var GetResults = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var mathsresults, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, MathsResult_1.default.find()];
            case 1:
                mathsresults = _a.sent();
...
var AddResult = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var newMathsResult, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                newMathsResult = req.body;
                if (!newMathsResult.contentId) {
                    throw new validation_error_1.default("Result contentId is required");
                }
                return [4 /*yield*/, MathsResult_1.default.create(newMathsResult)];
            case 1:
                _a.sent();
